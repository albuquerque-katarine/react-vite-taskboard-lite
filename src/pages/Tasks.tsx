                        ...
                        result?.map(task=> (                            
                            <tr key={task.id} className="w-full text-left">
                                ...
                                <td className={`${theme === 'light' ? 'text-white' : 'text-gray-color'} p-2`}>
                                    <Link to={`/detail/${task.id}`} className={`${theme === 'light' ? 'text-white' : 'hover:bg-teal-100 text-gray-color'} hover:bg-teal-600 font-bold py-2 px-3 rounded-[10px] w-full max-w-[130px] lg:max-w-[200px] text-center`}>Ver detalhes</Link>
                                </td>
                            </tr>
                        ))
                    }
